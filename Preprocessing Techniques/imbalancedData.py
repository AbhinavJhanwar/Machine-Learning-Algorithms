...
df = pd.read_csv("C:/Users/abhinav.jhanwar/OneDrive - Accenture/Accenture/Tutorials/Machine Learning/Elite data Science/balance-scale.data", names=['balance', 'var1', 'var2', 'var3', 'var4'])
